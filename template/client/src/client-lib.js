!(function (t, e) {
  ...
  return (
    (t = {
      150: (t) => {
        'use strict';
        t.exports = JSON.parse('{"webpackDevPort":8080,"serverDevPort":3000}');
      },
      541: (t) => {
        function e(t, e, i, s) {
          const o =
      ...
      754: (t, e, i) => {
        const s = i(391),
          { clientMethods: o, linkMethods: n } = i(225),
          c = i(150),
          a =
            'localhost' === window.location.hostname
              ? 'ws://localhost:' + c.serverDevPort
          ...
          setup(t) {
            (this.game = t),
              ...
              document.addEventListener('click', function (e) {
                if (t.click) {
                  const i = e.clientX - window.innerWidth / 2,
                    s = e.clientY - window.innerHeight / 2;
                  t.click(
                    t.cameras.main.scrollX + window.innerWidth / 2 + i,
                    t.cameras.main.scrollY + window.innerHeight / 2 + s
                  );
                }
              }),
              n(this, o);
